...
- Download the datasets for De-En and Zh-EN (see the details in next section, note that <b> the training data is up to 10M sentence pairs and those in data/train-sample are the samples </b>).  <br />
